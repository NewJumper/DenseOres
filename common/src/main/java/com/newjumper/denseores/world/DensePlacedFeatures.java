...
public class DensePlacedFeatures {
    public static final ResourceKey<PlacedFeature> DENSE_COAL = key("dense_coal");
    public static final ResourceKey<PlacedFeature> DENSE_COAL_BURIED = key("dense_coal_buried");
    public static final ResourceKey<PlacedFeature> DENSE_IRON_SMALL = key("dense_iron_small");
    public static final ResourceKey<PlacedFeature> DENSE_IRON_LARGE = key("dense_iron_large");
    public static final ResourceKey<PlacedFeature> DENSE_COPPER = key("dense_copper");
    public static final ResourceKey<PlacedFeature> DENSE_GOLD = key("dense_gold");
    public static final ResourceKey<PlacedFeature> DENSE_GOLD_EXTRA = key("dense_gold_extra");
    public static final ResourceKey<PlacedFeature> DENSE_REDSTONE_UPPER = key("dense_redstone_upper");
    public static final ResourceKey<PlacedFeature> DENSE_REDSTONE_LOWER = key("dense_redstone_lower");
    public static final ResourceKey<PlacedFeature> DENSE_EMERALD = key("dense_emerald");
    public static final ResourceKey<PlacedFeature> DENSE_LAPIS_UPPER = key("dense_lapis_upper");
    public static final ResourceKey<PlacedFeature> DENSE_LAPIS_LOWER = key("dense_lapis_lower");
    public static final ResourceKey<PlacedFeature> DENSE_DIAMOND_SMALL = key("dense_diamond_small");
    public static final ResourceKey<PlacedFeature> DENSE_DIAMOND_LARGE = key("dense_diamond_large");

    public static final ResourceKey<PlacedFeature> DENSE_NETHER_GOLD = key("dense_nether_gold");
    public static final ResourceKey<PlacedFeature> DENSE_NETHER_QUARTZ = key("dense_nether_quartz");
    public static final ResourceKey<PlacedFeature> ANCIENT_NETHER_UPPER = key("ancient_nether_upper");
    public static final ResourceKey<PlacedFeature> ANCIENT_NETHER_LOWER = key("ancient_nether_lower");
    ...
    private static ResourceKey<PlacedFeature> key(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, DenseOres.id(name));
    }
}
