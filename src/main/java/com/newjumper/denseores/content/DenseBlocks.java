...
public class DenseBlocks {
    ...
    public static final RegistryObject<Block> ANCIENT_NETHER_ORE = register("ancient_nether_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.NETHERRACK).strength(12, 100), UniformInt.of(1, 2)));
