...
public class DenseOresBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).addTags(DenseOresTags.Blocks.DENSE_ORES, DenseOresTags.Blocks.DENSE_DEEPSLATE_ORES);
        ...
        tag(BlockTags.GOLD_ORES).add(DenseBlocks.DENSE_GOLD_ORE.get(), DenseBlocks.DENSE_DEEPSLATE_GOLD_ORE.get());
        ...
        tag(Tags.Blocks.ORES).addTags(DenseOresTags.Blocks.DENSE_ORES, DenseOresTags.Blocks.DENSE_DEEPSLATE_ORES);
        ...
        tag(Tags.Blocks.ORES_GOLD).add(DenseBlocks.DENSE_GOLD_ORE.get(), DenseBlocks.DENSE_DEEPSLATE_GOLD_ORE.get());
        ...
        tag(Tags.Blocks.ORE_RATES_DENSE).addTags(DenseOresTags.Blocks.DENSE_ORES, DenseOresTags.Blocks.DENSE_DEEPSLATE_ORES);
        tag(Tags.Blocks.ORES_IN_GROUND_STONE).addTag(DenseOresTags.Blocks.DENSE_ORES);
        tag(Tags.Blocks.ORES_IN_GROUND_DEEPSLATE).addTag(DenseOresTags.Blocks.DENSE_DEEPSLATE_ORES);

        tag(DenseOresTags.Blocks.DENSE_ORES).add(DenseBlocks.DENSE_COAL_ORE.get(), DenseBlocks.DENSE_IRON_ORE.get(), DenseBlocks.DENSE_COPPER_ORE.get(), DenseBlocks.DENSE_GOLD_ORE.get(), DenseBlocks.DENSE_REDSTONE_ORE.get(), DenseBlocks.DENSE_EMERALD_ORE.get(), DenseBlocks.DENSE_LAPIS_ORE.get(), DenseBlocks.DENSE_DIAMOND_ORE.get());
