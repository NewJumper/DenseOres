...
public class DenseConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_DENSE_GOLD = CONFIGURED_FEATURES.register("ore_dense_gold", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(DENSE_GOLD_TARGET_LIST.get(), 8, 0.3f)));
    public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_DENSE_GOLD_EXTRA = CONFIGURED_FEATURES.register("ore_dense_gold_extra", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(DENSE_GOLD_TARGET_LIST.get(), 7, 0.2f)));
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_DENSE_EMERALD = CONFIGURED_FEATURES.register("ore_dense_emerald", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(DENSE_EMERALD_TARGET_LIST.get(), 6, 0.5f)));
