...
public class DenseConfiguredFeatures {
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> DENSE_GOLD_TARGET_LIST = Suppliers.memoize(() -> List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, DenseBlocks.DENSE_GOLD_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, DenseBlocks.DENSE_DEEPSLATE_GOLD_ORE.get().defaultBlockState())));
